...
class Composite(models.Model):
    user = models.ForeignKey(User, related_name='composites', on_delete=models.CASCADE)
    created = models.DateTimeField(auto_now_add=True)
    last_modified = models.DateTimeField(auto_now=True)
    data = models.TextField()

class CompositeNonce(models.Model):
    user = models.ForeignKey(User, related_name='composite_nonces', on_delete=models.CASCADE)
    composite = models.ForeignKey(Composite, related_name='nonces', on_delete=models.CASCADE)
